...
const SnapPoints1: NextPage = () => {
  return (
    <div className="self-stretch flex flex-row items-start justify-start gap-[124px] max-w-full z-[1] text-center text-9xl text-gray-gray-900 font-footer-footer-sm lg:gap-[124px_62px] mq450:gap-[124px_15px] mq750:gap-[124px_31px] mq1050:flex-wrap">
      <img
      ...
      <div className="w-[534px] flex flex-col items-start justify-start pt-5 px-0 pb-0 box-border min-w-[534px] max-w-full mq750:min-w-full mq1050:flex-1">
        <div className="self-stretch flex flex-col items-start justify-start gap-[10px] max-w-full">
          ...
          <div className="w-[503px] flex flex-col items-start justify-start gap-[20px] max-w-full text-left text-lg text-gray-gray-800">
            ...
            <div className="w-[453px] flex flex-col items-start justify-start gap-[25px] max-w-full text-base text-gray-gray-900">
              <div className="self-stretch flex flex-row items-start justify-start gap-[15px] max-w-full mq450:flex-wrap">
              ...
              <div className="flex flex-row items-start justify-start gap-[10px]">
                ...
                <div className="flex flex-col items-start justify-start gap-[5px]">
                  ...
                  <div className="relative text-smi text-gray-gray-600">
                    CEO
                  </div>
                </div>
              </div>
